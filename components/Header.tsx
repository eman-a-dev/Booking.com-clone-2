...
const[mobileMenuopen, setMobileMenuOpen] = useState(false);
  ...
  return (
    ...
    <span className="sr-only">Booking.com</span>
     <Link className="-m-1.5 p-1.5 text-xl font-bold text-white" href="/">
      <h2>Booking.com</h2>
      </Link>
     </div>
     ...
     <div className="flex lg:hidden">
      ...
      <div className="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" className="text-sm font-semibold leading-6 text-white">
          Log in <span aria-hidden="true">&arr;</span>
        </a>
      </div>
      </nav>
      ...
      >
        ...
        overflow-y-auto bg-[#013B94] px-6 sm:ring-1
        sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Your Company</span>
                <h2 className="h-8 w-auto font-bold text-lg text-white">Booking.com</h2>
              </a>
              <button 
              type="button"
              className="-m-2.5 rounded-mdnp-2.5 text-white"
                      ...
                      <>
                         ...
                         <Disclosure.Panel className="mt-2 space-y-2">
                            {[...products, ...callToAction].map((item) => (
                              ...
                              as="a"
                              href={item.href}
                              className="block rounded-lg py-2 l-6 pr-3 text-sm font-semibold leading-6 text-white
                              hover:bg-blue-800">
                                {item.name}
                              </Disclosure.Button>
                            ))}
